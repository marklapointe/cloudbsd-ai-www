...
- **Sidebar (Left)**: 
    ...
    - Top Section: 
        - Brand logo (Blue-500 box with white 'C') and "CloudBSD Admin" title (White, text-xl, bold).
        - User profile section: User icon, Username, and Role (Blue-500) in a high-contrast card.
    - Middle: Navigation links with Lucide icons (Dashboard, Cluster, VMs, Containers, Jails, Network Map, Users, Logs, Settings). 
        - Active link: Brand-600 background (10% opacity), Brand-400 text, Blue-500 indicator dot.
        - Inactive link: Transparent background, Slate-400 text, Slate-900 on hover.
    - Bottom Section:
        - **User Manual**: "User Manual" button (FileText icon, Brand-500 themed).
        - **Logout**: Logout button (LogOut icon, Slate-400 text, Red-hover).
- **Backend Status Bar**:
