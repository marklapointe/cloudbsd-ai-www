...
const CustomPageSizeModal: React.FC<CustomPageSizeModalProps> = ({ 
  isOpen, 
  onClose, 
  onConfirm,
  initialValue
        ...
        <form onSubmit={handleSubmit} className="p-8 space-y-6">
          <div>
            ...
            <input 
              ...
              className="w-full px-6 py-4 bg-slate-50 border border-slate-100 rounded-2xl focus:ring-4 focus:ring-brand-500/10 focus:border-brand-500 focus:bg-white transition-all duration-200 outline-none font-bold text-slate-900 text-lg"
              placeholder="10"
            />
          </div>
...
export default CustomPageSizeModal;
