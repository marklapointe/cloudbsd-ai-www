...
15. **Security Enhancements**:
    ...
    - **Unified Backend & Listen Configuration**:
        ...
        - Enabled `trust proxy` in the Express backend to support running behind reverse proxies (like Nginx), ensuring correct handling of `X-Forwarded-*` headers and protocols.
