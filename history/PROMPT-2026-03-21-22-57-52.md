...
21. **Node.js 24 & Native TypeScript**:
    ...
    - Implemented SPA routing with a catch-all handler in the Express backend to support React Router, using `app.get('/:any?', ...)` for compatibility with Express 5/path-to-regexp v8+.
...
23. **Integrated Frontend Serving**:
    ...
    - Implemented Express `static` middleware and a `*` catch-all route for SPA navigation.
