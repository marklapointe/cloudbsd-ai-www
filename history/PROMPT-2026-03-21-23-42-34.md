...
26. **User Documentation**:
    - Created a comprehensive `USER_MANUAL.md` in the project root, providing detailed instructions for installation, authentication, resource management, and administration.
    - Linked the User Manual in the `README.md` for better discoverability.
    - Documented user roles, multi-language support, and FreeBSD-specific installation steps within the manual.
