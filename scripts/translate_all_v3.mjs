...
const dictionary = {
  ...
  "IP Address": { "es": "Dirección IP", "fr": "Adresse IP", "de": "IP-Adresse", "it": "Indirizzo IP", "pt": "Endereço IP", "bg": "IP адрес", "ru": "IP-адрес", "zh": "IP 地址", "ja": "IPアドレス", "ko": "IP 주со", "ar": "عنوان IP", "hi": "आईपी पता", "tr": "IP Adresi" },
  ...
  "License": { "es": "Licencia", "fr": "Licence", "de": "Lizenz", "it": "Licenza", "pt": "Licença", "bg": "Лиценз", "ru": "Лицензия", "zh": "许可证", "ja": "ライセンス", "ko": "ライ선스", "ar": "الترخيص", "tr": "Lisans" },
  ...
  "Warning": { "es": "Advertencia", "fr": "Avertissement", "de": "Warnung", "it": "Avviso", "pt": "Aviso", "bg": "Предупреждение", "ru": "Предупреждение", "zh": "警告", "ja": "警告", "ko": "경го", "ar": "تحذير", "tr": "Uyarı" },
  ...
  "Role": { "es": "Rol", "fr": "Rôle", "de": "Rolle", "it": "Ruolo", "bg": "Роля", "ru": "Роль" },
  "Close": { "es": "Cerrar", "fr": "Fermer", "de": "Schließen", "it": "Chiudi", "bg": "Затвори", "ru": "Закрыть" },
  "Admin": { "es": "Admin", "fr": "Admin", "de": "Admin", "it": "Admin", "bg": "Админ", "ru": "Админ" },
  "Operator": { "es": "Operador", "fr": "Opérateur", "de": "Operator", "it": "Operatore", "bg": "Оператор", "ru": "Оператор" },
  "Viewer": { "es": "Visor", "fr": "Observateur", "de": "Viewer", "it": "Visore", "bg": "Зрител", "ru": "Зритель" },
  "Unknown": { "es": "Desconocido", "fr": "Inconnu", "de": "Unbekannt", "it": "Sconosciuto", "bg": "Неизвестен", "ru": "Неизвестно" },
  "Host System": { "es": "Sistema host", "fr": "Système hôte", "de": "Hostsystem", "it": "Sistema host", "bg": "Хост система", "ru": "Хост-система" },
  "System": { "es": "Sistema", "fr": "Système", "de": "System", "it": "Sistema", "bg": "Система", "ru": "Система" },
  "Storage": { "es": "Almacenamiento", "fr": "Stockage", "de": "Speicher", "it": "Archiviazione", "bg": "Склад", "ru": "Хранилище" },
  "Image": { "es": "Imagen", "fr": "Image", "de": "Bild", "it": "Immagine", "bg": "Изображение", "ru": "Образ" },
  "Health": { "es": "Salud", "fr": "Santé", "de": "Gesundheit", "it": "Salute", "bg": "Здраве", "ru": "Здоровье" },
  "Active": { "es": "Activo", "fr": "Actif", "de": "Aktiv", "it": "Attivo", "bg": "Активен", "ru": "Активен" },
  "Inactive": { "es": "Inactivo", "fr": "Inactif", "de": "Inaktiv", "it": "Inattivo", "bg": "Неактивен", "ru": "Неактивен" }
};
